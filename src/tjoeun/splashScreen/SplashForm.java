...
public class SplashForm extends javax.swing.JFrame {
    ...
    public SplashForm() {
        initComponents();
        tjoeun.DataConnection.ConnectionClass.connection();     
        new Thread()
        {
            @Override
            public void run()
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/tjoeun/splashScreen/SplashGMS.gif"))); // NOI18N
